...
function base16-cupcake -d "Cupcake"
  ...
  set -g fish_color_autosuggestion d8d5dd
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment d8d5dd
  ...
  set -g fish_color_param a59daf
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=d8d5dd
  set -g fish_color_selection white --bold --background=d8d5dd
