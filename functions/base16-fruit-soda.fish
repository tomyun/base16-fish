...
function base16-fruit-soda -d "Fruit Soda"
  ...
  set -g fish_color_autosuggestion d8d5d5
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment d8d5d5
  ...
  set -g fish_color_param 979598
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=d8d5d5
  set -g fish_color_selection white --bold --background=d8d5d5
