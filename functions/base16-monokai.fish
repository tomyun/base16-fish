...
function base16-monokai -d "Monokai"
  ...
  set -g fish_color_autosuggestion 49483e
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 49483e
  ...
  set -g fish_color_param a59f85
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=49483e
  set -g fish_color_selection white --bold --background=49483e
