...
function base16-sandcastle -d "Sandcastle"
  set color00 28/2c/34 # Base 00 - Black
  set color01 83/a5/98 # Base 08 - Red
  set color02 52/8b/8b # Base 0B - Green
  set color03 a0/7e/3b # Base 0A - Yellow
  set color04 83/a5/98 # Base 0D - Blue
  set color05 d7/5f/5f # Base 0E - Magenta
  set color06 83/a5/98 # Base 0C - Cyan
  ...
  set color16 a0/7e/3b # Base 09
  set color17 a8/73/22 # Base 0F
  set color18 2c/32/3b # Base 01
