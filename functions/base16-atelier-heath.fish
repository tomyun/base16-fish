...
function base16-atelier-heath -d "Atelier Heath"
  ...
  set -g fish_color_autosuggestion 695d69
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 695d69
  ...
  set -g fish_color_param 9e8f9e
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=695d69
  set -g fish_color_selection white --bold --background=695d69
  ...
  set -g base16_theme atelier-heath
