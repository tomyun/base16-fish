...
function base16-kimber -d "Kimber"
  ...
  set -g fish_color_autosuggestion 555D55
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 555D55
  ...
  set -g fish_color_param 5A5A5A
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=555D55
  set -g fish_color_selection white --bold --background=555D55
