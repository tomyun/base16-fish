...
function base16-brewer -d "Brewer"
  ...
  set -g fish_color_autosuggestion 515253
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 515253
  ...
  set -g fish_color_param 959697
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=515253
  set -g fish_color_selection white --bold --background=515253
