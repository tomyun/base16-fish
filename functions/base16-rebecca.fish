...
function base16-rebecca -d "Rebecca"
  ...
  set -g fish_color_autosuggestion 383a62
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 383a62
  ...
  set -g fish_color_param a0a0c5
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=383a62
  set -g fish_color_selection white --bold --background=383a62
