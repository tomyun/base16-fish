...
function base16-atelier-heath-light -d "Atelier Heath Light"
  ...
  set -g fish_color_autosuggestion ab9bab
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment ab9bab
  ...
  set -g fish_color_param 776977
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=ab9bab
  set -g fish_color_selection white --bold --background=ab9bab
  ...
  set -g base16_theme atelier-heath-light
