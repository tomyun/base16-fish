...
function base16-atelier-lakeside -d "Atelier Lakeside"
  ...
  set -g fish_color_autosuggestion 516d7b
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 516d7b
  ...
  set -g fish_color_param 7195a8
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=516d7b
  set -g fish_color_selection white --bold --background=516d7b
  ...
  set -g base16_theme atelier-lakeside
