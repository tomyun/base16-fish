...
function base16-marrakesh -d "Marrakesh"
  ...
  set -g fish_color_autosuggestion 5f5b17
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 5f5b17
  ...
  set -g fish_color_param 86813b
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=5f5b17
  set -g fish_color_selection white --bold --background=5f5b17
