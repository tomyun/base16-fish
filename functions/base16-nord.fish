...
function base16-nord -d "Nord"
  ...
  set -g fish_color_autosuggestion 434C5E
  ...
  set -g fish_color_search_match bryellow --background=434C5E
  set -g fish_color_selection white --bold --background=434C5E
