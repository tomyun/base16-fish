...
function base16-icy -d "Icy Dark"
  ...
  set -g fish_color_autosuggestion 041f23
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 041f23
  ...
  set -g fish_color_param 064048
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=041f23
  set -g fish_color_selection white --bold --background=041f23
