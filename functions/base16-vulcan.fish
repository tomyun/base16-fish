...
function base16-vulcan -d "vulcan"
  ...
  set -g fish_color_autosuggestion 003552
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 003552
  ...
  set -g fish_color_param 6b6977
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=003552
  set -g fish_color_selection white --bold --background=003552
