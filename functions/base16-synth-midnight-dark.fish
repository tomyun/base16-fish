...
function base16-synth-midnight-dark -d "Synth Midnight Terminal Dark"
  ...
  set -g fish_color_autosuggestion 28292a
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 28292a
  ...
  set -g fish_color_param a3a5a6
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=28292a
  set -g fish_color_selection white --bold --background=28292a
  ...
  set -g base16_theme synth-midnight-dark
