...
function base16-gruvbox-dark-pale -d "Gruvbox dark, pale"
  ...
  set -g fish_color_param 949494
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=4e4e4e
  set -g fish_color_selection white --bold --background=4e4e4e
  ...
  set -g base16_theme gruvbox-dark-pale
