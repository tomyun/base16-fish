...
function base16-atelier-plateau-light -d "Atelier Plateau Light"
  ...
  set -g fish_color_autosuggestion 8a8585
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 8a8585
  ...
  set -g fish_color_param 655d5d
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=8a8585
  set -g fish_color_selection white --bold --background=8a8585
  ...
  set -g base16_theme atelier-plateau-light
