...
function base16-flat -d "Flat"
  ...
  set -g fish_color_autosuggestion 7F8C8D
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 7F8C8D
  ...
  set -g fish_color_param BDC3C7
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=7F8C8D
  set -g fish_color_selection white --bold --background=7F8C8D
