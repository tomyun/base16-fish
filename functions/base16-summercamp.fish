...
function base16-summercamp -d "summercamp"
  set color00 1c/18/10 # Base 00 - Black
  set color01 e3/51/42 # Base 08 - Red
  ...
  set -g fish_color_autosuggestion 3a3527
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 3a3527
  ...
  set -g fish_color_param 5f5b45
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=3a3527
  set -g fish_color_selection white --bold --background=3a3527
