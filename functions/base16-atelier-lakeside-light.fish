...
function base16-atelier-lakeside-light -d "Atelier Lakeside Light"
  ...
  set -g fish_color_autosuggestion 7ea2b4
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 7ea2b4
  ...
  set -g fish_color_param 5a7b8c
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=7ea2b4
  set -g fish_color_selection white --bold --background=7ea2b4
  ...
  set -g base16_theme atelier-lakeside-light
