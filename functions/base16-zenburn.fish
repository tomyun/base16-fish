...
function base16-zenburn -d "Zenburn"
  ...
  set -g fish_color_comment 606060
  ...
  set -g fish_color_search_match bryellow --background=606060
  set -g fish_color_selection white --bold --background=606060
