...
function base16-windows-nt-light -d "Windows NT Light"
  ...
  set -g fish_color_autosuggestion d5d5d5
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment d5d5d5
  ...
  set -g fish_color_param a0a0a0
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=d5d5d5
  set -g fish_color_selection white --bold --background=d5d5d5
  ...
  set -g base16_theme windows-nt-light
