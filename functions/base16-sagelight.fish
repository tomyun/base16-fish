...
function base16-sagelight -d "Sagelight"
  ...
  set -g fish_color_autosuggestion d8d8d8
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment d8d8d8
  ...
  set -g fish_color_param 585858
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=d8d8d8
  set -g fish_color_selection white --bold --background=d8d8d8
