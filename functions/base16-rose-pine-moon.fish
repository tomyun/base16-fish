...
function base16-rose-pine-moon -d "Rosé Pine Moon"
  ...
  set -U fish_color_autosuggestion 393552
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment 393552
  ...
  set -U fish_color_selection white --bold --background=393552
  ...
  set -U base16_theme rose-pine-moon
