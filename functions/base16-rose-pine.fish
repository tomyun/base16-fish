...
function base16-rose-pine -d "Rosé Pine"
  ...
  set -g fish_color_autosuggestion 26233a
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 26233a
  ...
  set -g fish_color_param 6e6a86
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=26233a
  set -g fish_color_selection white --bold --background=26233a
