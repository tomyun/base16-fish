...
function base16-summerfruit-dark -d "Summerfruit Dark"
  ...
  set -g fish_color_comment 303030
  ...
  set -g fish_color_search_match bryellow --background=303030
  set -g fish_color_selection white --bold --background=303030
  ...
  set -g base16_theme summerfruit-dark
