...
function base16-atelier-forest-light -d "Atelier Forest Light"
  ...
  set -g fish_color_autosuggestion a8a19f
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment a8a19f
  ...
  set -g fish_color_param 766e6b
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=a8a19f
  set -g fish_color_selection white --bold --background=a8a19f
  ...
  set -g base16_theme atelier-forest-light
