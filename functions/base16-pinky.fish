...
function base16-pinky -d "pinky"
  ...
  set -g fish_color_autosuggestion 1d1b1d
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 1d1b1d
  ...
  set -g fish_color_param e7dbdb
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=1d1b1d
  set -g fish_color_selection white --bold --background=1d1b1d
