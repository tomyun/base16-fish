...
function base16-tomorrow-night-eighties -d "Tomorrow Night"
  ...
  set -g fish_color_autosuggestion 515151
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 515151
  ...
  set -g fish_color_param b4b7b4
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=515151
  set -g fish_color_selection white --bold --background=515151
  ...
  set -g base16_theme tomorrow-night-eighties
