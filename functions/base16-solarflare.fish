...
function base16-solarflare -d "Solar Flare"
  ...
  set -g fish_color_autosuggestion 586875
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 586875
  ...
  set -g fish_color_param 85939E
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=586875
  set -g fish_color_selection white --bold --background=586875
