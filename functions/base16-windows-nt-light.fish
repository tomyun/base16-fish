...
function base16-windows-nt-light -d "Windows NT Light"
  ...
  set -U fish_color_autosuggestion d5d5d5
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment d5d5d5
  ...
  set -U fish_color_selection white --bold --background=d5d5d5
  ...
  set -U base16_theme windows-nt-light
