...
function base16-spacemacs -d "Spacemacs"
  ...
  set -g fish_color_autosuggestion 444155
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 444155
  ...
  set -g fish_color_search_match bryellow --background=444155
  set -g fish_color_selection white --bold --background=444155
