...
function base16-darkmoss -d "darkmoss"
  ...
  set -g fish_color_autosuggestion 373c3d
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 373c3d
  ...
  set -g fish_color_param 818f80
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=373c3d
  set -g fish_color_selection white --bold --background=373c3d
