...
function base16-humanoid-dark -d "Humanoid dark"
  ...
  set -U fish_color_autosuggestion 484e54
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment 484e54
  ...
  set -U fish_color_selection white --bold --background=484e54
  ...
  set -U base16_theme humanoid-dark
