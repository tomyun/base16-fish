...
function base16-atelier-cave-light -d "Atelier Cave Light"
  ...
  set -g fish_color_autosuggestion 8b8792
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 8b8792
  ...
  set -g fish_color_param 655f6d
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=8b8792
  set -g fish_color_selection white --bold --background=8b8792
  ...
  set -g base16_theme atelier-cave-light
