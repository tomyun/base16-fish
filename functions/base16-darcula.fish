...
function base16-darcula -d "Darcula"
  ...
  set -g fish_color_autosuggestion 323232
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 323232
  ...
  set -g fish_color_param a4a3a3
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=323232
  set -g fish_color_selection white --bold --background=323232
