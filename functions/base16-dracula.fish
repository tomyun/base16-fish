...
function base16-dracula -d "Dracula"
  ...
  set -g fish_color_autosuggestion 4d4f68
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 4d4f68
  ...
  set -g fish_color_param 62d6e8
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=4d4f68
  set -g fish_color_selection white --bold --background=4d4f68
