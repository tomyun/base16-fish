...
function base16-horizon-terminal-light -d "Horizon Light"
  ...
  set -g fish_color_autosuggestion F9CBBE
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment F9CBBE
  ...
  set -g fish_color_param 948C8A
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=F9CBBE
  set -g fish_color_selection white --bold --background=F9CBBE
  ...
  set -g base16_theme horizon-terminal-light
