...
function base16-helios -d "Helios"
  ...
  set -g fish_color_autosuggestion 53585b
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 53585b
  ...
  set -g fish_color_search_match bryellow --background=53585b
  set -g fish_color_selection white --bold --background=53585b
