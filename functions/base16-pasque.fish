...
function base16-pasque -d "Pasque"
  ...
  set -g fish_color_autosuggestion 3E2D5C
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 3E2D5C
  ...
  set -g fish_color_param BEBCBF
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=3E2D5C
  set -g fish_color_selection white --bold --background=3E2D5C
