...
function base16-humanoid-dark -d "Humanoid dark"
  ...
  set -g fish_color_autosuggestion 484e54
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 484e54
  ...
  set -g fish_color_param c0c0bd
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=484e54
  set -g fish_color_selection white --bold --background=484e54
  ...
  set -g base16_theme humanoid-dark
