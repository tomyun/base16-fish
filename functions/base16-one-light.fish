...
function base16-one-light -d "One Light"
  ...
  set -g fish_color_autosuggestion e5e5e6
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment e5e5e6
  ...
  set -g fish_color_param 696c77
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=e5e5e6
  set -g fish_color_selection white --bold --background=e5e5e6
