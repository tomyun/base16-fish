...
function base16-porple -d "Porple"
  ...
  set -g fish_color_autosuggestion 474160
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 474160
  ...
  set -g fish_color_search_match bryellow --background=474160
  set -g fish_color_selection white --bold --background=474160
