...
function base16-windows-10 -d "Windows 10"
  ...
  set -U fish_color_autosuggestion 535353
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment 535353
  ...
  set -U fish_color_selection white --bold --background=535353
