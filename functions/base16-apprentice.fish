...
function base16-apprentice -d "Apprentice"
  ...
  set -g fish_color_param 787878
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=333333
  set -g fish_color_selection white --bold --background=333333
