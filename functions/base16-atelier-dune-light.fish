...
function base16-atelier-dune-light -d "Atelier Dune Light"
  ...
  set -g fish_color_comment a6a28c
  ...
  set -g fish_color_param 7d7a68
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=a6a28c
  set -g fish_color_selection white --bold --background=a6a28c
  ...
  set -g base16_theme atelier-dune-light
