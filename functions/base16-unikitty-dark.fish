...
function base16-unikitty-dark -d "Unikitty Dark"
  ...
  set -g fish_color_autosuggestion 666369
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 666369
  ...
  set -g fish_color_param 9f9da2
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=666369
  set -g fish_color_selection white --bold --background=666369
  ...
  set -g base16_theme unikitty-dark
