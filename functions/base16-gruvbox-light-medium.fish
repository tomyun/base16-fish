...
function base16-gruvbox-light-medium -d "Gruvbox light, medium"
  ...
  set -g fish_color_search_match bryellow --background=d5c4a1
  set -g fish_color_selection white --bold --background=d5c4a1
  ...
  set -g base16_theme gruvbox-light-medium
