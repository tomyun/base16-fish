...
function base16-greenscreen -d "Green Screen"
  ...
  set -g fish_color_autosuggestion 005500
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 005500
  ...
  set -g fish_color_param 009900
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=005500
  set -g fish_color_selection white --bold --background=005500
  ...
  set -g base16_theme greenscreen
