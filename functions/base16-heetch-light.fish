...
function base16-heetch-light -d "Heetch Light"
  ...
  set -g fish_color_autosuggestion 7b6d8b
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 7b6d8b
  ...
  set -g fish_color_param ddd6e5
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=7b6d8b
  set -g fish_color_selection white --bold --background=7b6d8b
  ...
  set -g base16_theme heetch-light
