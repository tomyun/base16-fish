...
function base16-danqing -d "DanQing"
  ...
  set -g fish_color_autosuggestion 5a605d
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 5a605d
  ...
  set -g fish_color_param cad8d2
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=5a605d
  set -g fish_color_selection white --bold --background=5a605d
