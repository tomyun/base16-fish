...
function base16-shades-of-purple -d "Shades of Purple"
  ...
  set -g fish_color_autosuggestion f1d000
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment f1d000
  ...
  set -g fish_color_param 6871ff
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=f1d000
  set -g fish_color_selection white --bold --background=f1d000
  ...
  set -g base16_theme shades-of-purple
