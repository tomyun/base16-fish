...
function base16-3024 -d "3024"
  ...
  set -g fish_color_autosuggestion 4a4543
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 4a4543
  ...
  set -g fish_color_param 807d7c
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=4a4543
  set -g fish_color_selection white --bold --background=4a4543
