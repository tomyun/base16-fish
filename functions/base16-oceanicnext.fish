...
function base16-oceanicnext -d "OceanicNext"
  ...
  set -g fish_color_autosuggestion 4F5B66
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 4F5B66
  ...
  set -g fish_color_param A7ADBA
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=4F5B66
  set -g fish_color_selection white --bold --background=4F5B66
  ...
  set -g base16_theme oceanicnext
