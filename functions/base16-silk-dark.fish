...
function base16-silk-dark -d "Silk Dark"
  ...
  set -g fish_color_autosuggestion 2A5054
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 2A5054
  ...
  set -g fish_color_param 9DC8CD
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=2A5054
  set -g fish_color_selection white --bold --background=2A5054
