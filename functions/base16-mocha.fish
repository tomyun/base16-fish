...
function base16-mocha -d "Mocha"
  ...
  set -g fish_color_autosuggestion 645240
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 645240
  ...
  set -g fish_color_param b8afad
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=645240
  set -g fish_color_selection white --bold --background=645240
