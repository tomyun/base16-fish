...
function base16-atelier-plateau -d "Atelier Plateau"
  ...
  set -g fish_color_autosuggestion 585050
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 585050
  ...
  set -g fish_color_param 7e7777
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=585050
  set -g fish_color_selection white --bold --background=585050
  ...
  set -g base16_theme atelier-plateau
