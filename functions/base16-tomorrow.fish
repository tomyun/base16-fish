...
function base16-tomorrow -d "Tomorrow"
  ...
  set -g fish_color_autosuggestion d6d6d6
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment d6d6d6
  ...
  set -g fish_color_search_match bryellow --background=d6d6d6
  set -g fish_color_selection white --bold --background=d6d6d6
