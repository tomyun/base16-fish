...
function base16-atelier-forest -d "Atelier Forest"
  ...
  set -g fish_color_autosuggestion 68615e
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 68615e
  ...
  set -g fish_color_param 9c9491
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=68615e
  set -g fish_color_selection white --bold --background=68615e
  ...
  set -g base16_theme atelier-forest
