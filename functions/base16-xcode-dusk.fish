...
function base16-xcode-dusk -d "XCode Dusk"
  ...
  set -g fish_color_autosuggestion 53555D
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 53555D
  ...
  set -g fish_color_param 7E8086
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=53555D
  set -g fish_color_selection white --bold --background=53555D
