...
function base16-material-lighter -d "Material Lighter"
  ...
  set -g fish_color_autosuggestion CCEAE7
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment CCEAE7
  ...
  set -g fish_color_search_match bryellow --background=CCEAE7
  set -g fish_color_selection white --bold --background=CCEAE7
  ...
  set -g base16_theme material-lighter
