...
function base16-seti -d "Seti UI"
  ...
  set -g fish_color_autosuggestion 3B758C
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 3B758C
  ...
  set -g fish_color_param 43a5d5
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=3B758C
  set -g fish_color_selection white --bold --background=3B758C
