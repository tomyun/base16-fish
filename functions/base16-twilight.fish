...
function base16-twilight -d "Twilight"
  ...
  set -g fish_color_autosuggestion 464b50
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 464b50
  ...
  set -g fish_color_param 838184
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=464b50
  set -g fish_color_selection white --bold --background=464b50
