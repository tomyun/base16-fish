...
function base16-tender -d "tender"
  ...
  set -g fish_color_autosuggestion 484848
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 484848
  ...
  set -g fish_color_search_match bryellow --background=484848
  set -g fish_color_selection white --bold --background=484848
