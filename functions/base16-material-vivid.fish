...
function base16-material-vivid -d "Material Vivid"
  ...
  set -g fish_color_autosuggestion 323639
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 323639
  ...
  set -g fish_color_param 676c71
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=323639
  set -g fish_color_selection white --bold --background=323639
  ...
  set -g base16_theme material-vivid
