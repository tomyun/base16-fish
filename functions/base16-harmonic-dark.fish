...
function base16-harmonic-dark -d "Harmonic16 Dark"
  ...
  set -g fish_color_autosuggestion 405c79
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 405c79
  ...
  set -g fish_color_param aabcce
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=405c79
  set -g fish_color_selection white --bold --background=405c79
  ...
  set -g base16_theme harmonic-dark
