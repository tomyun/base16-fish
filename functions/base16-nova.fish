...
function base16-nova -d "Nova"
  ...
  set -g fish_color_autosuggestion 6A7D89
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 6A7D89
  ...
  set -g fish_color_param 899BA6
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=6A7D89
  set -g fish_color_selection white --bold --background=6A7D89
