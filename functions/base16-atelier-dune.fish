...
function base16-atelier-dune -d "Atelier Dune"
  ...
  set -g fish_color_autosuggestion 6e6b5e
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 6e6b5e
  ...
  set -g fish_color_param 999580
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=6e6b5e
  set -g fish_color_selection white --bold --background=6e6b5e
  ...
  set -g base16_theme atelier-dune
