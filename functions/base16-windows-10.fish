...
function base16-windows-10 -d "Windows 10"
  ...
  set -g fish_color_autosuggestion 535353
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 535353
  ...
  set -g fish_color_param b9b9b9
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=535353
  set -g fish_color_selection white --bold --background=535353
