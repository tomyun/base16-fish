...
function base16-grayscale-dark -d "Grayscale Dark"
  ...
  set -g fish_color_autosuggestion 464646
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 464646
  ...
  set -g fish_color_search_match bryellow --background=464646
  set -g fish_color_selection white --bold --background=464646
  ...
  set -g base16_theme grayscale-dark
