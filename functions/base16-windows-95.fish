...
function base16-windows-95 -d "Windows 95"
  set color00 00/00/00 # Base 00 - Black
  set color01 fc/54/54 # Base 08 - Red
  set color02 54/fc/54 # Base 0B - Green
  set color03 fc/fc/54 # Base 0A - Yellow
  set color04 54/54/fc # Base 0D - Blue
  set color05 fc/54/fc # Base 0E - Magenta
  set color06 54/fc/fc # Base 0C - Cyan
  set color07 a8/a8/a8 # Base 05 - White
  set color08 54/54/54 # Base 03 - Bright Black
  ...
  set color16 a8/54/00 # Base 09
  set color17 00/a8/00 # Base 0F
  set color18 1C/1C/1C # Base 01
  set color19 38/38/38 # Base 02
  set color20 7e/7e/7e # Base 04
  set color21 d2/d2/d2 # Base 06
  ...
  set -g fish_color_autosuggestion 383838
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 383838
  ...
  set -g fish_color_search_match bryellow --background=383838
  set -g fish_color_selection white --bold --background=383838
