...
function base16-google-dark -d "Google Dark"
  ...
  set -g fish_color_autosuggestion 373b41
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 373b41
  ...
  set -g fish_color_search_match bryellow --background=373b41
  set -g fish_color_selection white --bold --background=373b41
  ...
  set -g base16_theme google-dark
