...
function base16-codeschool -d "Codeschool"
  ...
  set -g fish_color_autosuggestion 2a343a
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 2a343a
  ...
  set -g fish_color_param 84898c
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=2a343a
  set -g fish_color_selection white --bold --background=2a343a
