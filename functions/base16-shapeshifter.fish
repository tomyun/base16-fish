...
function base16-shapeshifter -d "Shapeshifter"
  ...
  set -g fish_color_autosuggestion ababab
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment ababab
  ...
  set -g fish_color_param 343434
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=ababab
  set -g fish_color_selection white --bold --background=ababab
  ...
  set -g base16_theme shapeshifter
