...
function base16-rose-pine -d "Rosé Pine"
  ...
  set -U fish_color_autosuggestion 26233a
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment 26233a
  ...
  set -U fish_color_selection white --bold --background=26233a
