...
function base16-paraiso -d "Paraiso"
  ...
  set -g fish_color_autosuggestion 4f424c
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 4f424c
  ...
  set -g fish_color_param 8d8687
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=4f424c
  set -g fish_color_selection white --bold --background=4f424c
