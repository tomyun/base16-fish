...
function base16-equilibrium-gray-dark -d "Equilibrium Gray Dark"
  ...
  set -g fish_color_autosuggestion 262626
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 262626
  ...
  set -g fish_color_param 919191
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=262626
  set -g fish_color_selection white --bold --background=262626
  ...
  set -g base16_theme equilibrium-gray-dark
