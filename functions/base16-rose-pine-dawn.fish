...
function base16-rose-pine-dawn -d "Rosé Pine Dawn"
  ...
  set -g fish_color_autosuggestion f2e9de
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment f2e9de
  ...
  set -g fish_color_search_match bryellow --background=f2e9de
  set -g fish_color_selection white --bold --background=f2e9de
  ...
  set -g base16_theme rose-pine-dawn
