...
function base16-embers -d "Embers"
  ...
  set -g fish_color_autosuggestion 433B32
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 433B32
  ...
  set -g fish_color_param 8A8075
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=433B32
  set -g fish_color_selection white --bold --background=433B32
