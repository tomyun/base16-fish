...
function base16-material-palenight -d "Material Palenight"
  ...
  set -g fish_color_autosuggestion 32374D
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 32374D
  ...
  set -g fish_color_param 8796B0
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=32374D
  set -g fish_color_selection white --bold --background=32374D
  ...
  set -g base16_theme material-palenight
