...
function base16-woodland -d "Woodland"
  ...
  set -g fish_color_autosuggestion 48413a
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 48413a
  ...
  set -g fish_color_param b4a490
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=48413a
  set -g fish_color_selection white --bold --background=48413a
