...
function base16-atlas -d "Atlas"
  ...
  set -g fish_color_autosuggestion 517F8D
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 517F8D
  ...
  set -g fish_color_param 869696
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=517F8D
  set -g fish_color_selection white --bold --background=517F8D
