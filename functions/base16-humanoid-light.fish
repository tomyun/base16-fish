...
function base16-humanoid-light -d "Humanoid light"
  ...
  set -U fish_color_autosuggestion deded8
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment deded8
  ...
  set -U fish_color_selection white --bold --background=deded8
  ...
  set -U base16_theme humanoid-light
