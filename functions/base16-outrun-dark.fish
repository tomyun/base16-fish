...
function base16-outrun-dark -d "Outrun Dark"
  ...
  set -g fish_color_autosuggestion 30305A
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 30305A
  ...
  set -g fish_color_param B0B0DA
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=30305A
  set -g fish_color_selection white --bold --background=30305A
  ...
  set -g base16_theme outrun-dark
