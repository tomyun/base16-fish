...
function base16-edge-light -d "Edge Light"
  ...
  set -g fish_color_autosuggestion d69822
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment d69822
  ...
  set -g fish_color_param 6587bf
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=d69822
  set -g fish_color_selection white --bold --background=d69822
