...
function base16-silk-light -d "Silk Light"
  ...
  set -g fish_color_autosuggestion 90B7B6
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 90B7B6
  ...
  set -g fish_color_param 4B5B5F
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=90B7B6
  set -g fish_color_selection white --bold --background=90B7B6
