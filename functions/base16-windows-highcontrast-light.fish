...
function base16-windows-highcontrast-light -d "Windows High Contrast Light"
  ...
  set -g fish_color_autosuggestion d4d4d4
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment d4d4d4
  ...
  set -g fish_color_search_match bryellow --background=d4d4d4
  set -g fish_color_selection white --bold --background=d4d4d4
  ...
  set -g base16_theme windows-highcontrast-light
