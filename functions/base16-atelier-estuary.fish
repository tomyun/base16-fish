...
function base16-atelier-estuary -d "Atelier Estuary"
  ...
  set -g fish_color_autosuggestion 5f5e4e
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 5f5e4e
  ...
  set -g fish_color_param 878573
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=5f5e4e
  set -g fish_color_selection white --bold --background=5f5e4e
  ...
  set -g base16_theme atelier-estuary
