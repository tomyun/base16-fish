...
function base16-brogrammer -d "Brogrammer"
  ...
  set -g fish_color_autosuggestion 2dc55e
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 2dc55e
  ...
  set -g fish_color_param 2a84d2
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=2dc55e
  set -g fish_color_selection white --bold --background=2dc55e
