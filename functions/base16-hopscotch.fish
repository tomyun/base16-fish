...
function base16-hopscotch -d "Hopscotch"
  ...
  set -g fish_color_autosuggestion 5c545b
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 5c545b
  ...
  set -g fish_color_param 989498
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=5c545b
  set -g fish_color_selection white --bold --background=5c545b
