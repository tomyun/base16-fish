...
function base16-heetch -d "Heetch Dark"
  ...
  set -g fish_color_autosuggestion 5A496E
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 5A496E
  ...
  set -g fish_color_param 9C92A8
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=5A496E
  set -g fish_color_selection white --bold --background=5A496E
