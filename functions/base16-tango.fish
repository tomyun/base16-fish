...
function base16-tango -d "Tango"
  ...
  set -g fish_color_autosuggestion fce94f
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment fce94f
  ...
  set -g fish_color_param 729fcf
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=fce94f
  set -g fish_color_selection white --bold --background=fce94f
