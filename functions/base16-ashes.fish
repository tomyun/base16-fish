...
function base16-ashes -d "Ashes"
  ...
  set -g fish_color_autosuggestion 565E65
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 565E65
  ...
  set -g fish_color_param ADB3BA
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=565E65
  set -g fish_color_selection white --bold --background=565E65
