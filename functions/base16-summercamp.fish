...
function base16-summercamp -d "summercamp"
  ...
  set -U fish_color_autosuggestion 3a3527
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment 3a3527
  ...
  set -U fish_color_selection white --bold --background=3a3527
