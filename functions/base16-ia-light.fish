...
function base16-ia-light -d "iA Light"
  ...
  set -g fish_color_autosuggestion bde5f2
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment bde5f2
  ...
  set -g fish_color_param 767676
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=bde5f2
  set -g fish_color_selection white --bold --background=bde5f2
