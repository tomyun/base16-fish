...
function base16-atelier-sulphurpool-light -d "Atelier Sulphurpool Light"
  ...
  set -g fish_color_autosuggestion 979db4
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 979db4
  ...
  set -g fish_color_param 6b7394
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=979db4
  set -g fish_color_selection white --bold --background=979db4
  ...
  set -g base16_theme atelier-sulphurpool-light
