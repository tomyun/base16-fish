...
function base16-bespin -d "Bespin"
  ...
  set -g fish_color_autosuggestion 5e5d5c
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 5e5d5c
  ...
  set -g fish_color_param 797977
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=5e5d5c
  set -g fish_color_selection white --bold --background=5e5d5c
