...
function base16-dirtysea -d "dirtysea"
  ...
  set -g fish_color_autosuggestion d0d0d0
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment d0d0d0
  ...
  set -g fish_color_param 202020
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=d0d0d0
  set -g fish_color_selection white --bold --background=d0d0d0
