...
function base16-material -d "Material"
  ...
  set -g fish_color_autosuggestion 314549
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 314549
  ...
  set -g fish_color_search_match bryellow --background=314549
  set -g fish_color_selection white --bold --background=314549
