...
function base16-darkviolet -d "Dark Violet"
  ...
  set -g fish_color_autosuggestion 432d59
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 432d59
  ...
  set -g fish_color_param 00ff00
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=432d59
  set -g fish_color_selection white --bold --background=432d59
