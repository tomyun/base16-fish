...
function base16-ia-dark -d "iA Dark"
  ...
  set -g fish_color_autosuggestion 1d414d
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 1d414d
  ...
  set -g fish_color_search_match bryellow --background=1d414d
  set -g fish_color_selection white --bold --background=1d414d
