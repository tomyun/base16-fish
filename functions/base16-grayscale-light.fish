...
function base16-grayscale-light -d "Grayscale Light"
  ...
  set -g fish_color_autosuggestion b9b9b9
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment b9b9b9
  ...
  set -g fish_color_param 525252
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=b9b9b9
  set -g fish_color_selection white --bold --background=b9b9b9
  ...
  set -g base16_theme grayscale-light
