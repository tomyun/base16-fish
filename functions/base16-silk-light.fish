...
function base16-silk-light -d "Silk Light"
  ...
  set -U fish_color_autosuggestion 90B7B6
  set -U fish_color_cancel -r
  set -U fish_color_command green #white
  set -U fish_color_comment 90B7B6
  ...
  set -U fish_color_selection white --bold --background=90B7B6
