...
function base16-atelier-savanna-light -d "Atelier Savanna Light"
  ...
  set -g fish_color_autosuggestion 87928a
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 87928a
  ...
  set -g fish_color_param 5f6d64
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=87928a
  set -g fish_color_selection white --bold --background=87928a
  ...
  set -g base16_theme atelier-savanna-light
