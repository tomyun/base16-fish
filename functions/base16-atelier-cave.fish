...
function base16-atelier-cave -d "Atelier Cave"
  ...
  set -g fish_color_autosuggestion 585260
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 585260
  ...
  set -g fish_color_param 7e7887
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=585260
  set -g fish_color_selection white --bold --background=585260
  ...
  set -g base16_theme atelier-cave
