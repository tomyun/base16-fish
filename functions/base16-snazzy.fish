...
function base16-snazzy -d "Snazzy"
  ...
  set -g fish_color_autosuggestion 43454f
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 43454f
  ...
  set -g fish_color_param a5a5a9
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=43454f
  set -g fish_color_selection white --bold --background=43454f
