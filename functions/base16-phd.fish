...
function base16-phd -d "PhD"
  ...
  set -g fish_color_autosuggestion 4d5666
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 4d5666
  ...
  set -g fish_color_param 9a99a3
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=4d5666
  set -g fish_color_selection white --bold --background=4d5666
