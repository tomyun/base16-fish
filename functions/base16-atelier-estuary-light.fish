...
function base16-atelier-estuary-light -d "Atelier Estuary Light"
  ...
  set -g fish_color_autosuggestion 929181
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 929181
  ...
  set -g fish_color_param 6c6b5a
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=929181
  set -g fish_color_selection white --bold --background=929181
  ...
  set -g base16_theme atelier-estuary-light
