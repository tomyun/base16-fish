...
function base16-atelier-seaside-light -d "Atelier Seaside Light"
  ...
  set -g fish_color_autosuggestion 8ca68c
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 8ca68c
  ...
  set -g fish_color_param 687d68
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=8ca68c
  set -g fish_color_selection white --bold --background=8ca68c
  ...
  set -g base16_theme atelier-seaside-light
