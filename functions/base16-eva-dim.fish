...
function base16-eva-dim -d "Eva Dim"
  ...
  set -g fish_color_autosuggestion 4b6988
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 4b6988
  ...
  set -g fish_color_param 7e90a3
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=4b6988
  set -g fish_color_selection white --bold --background=4b6988
