...
function base16-black-metal-dark-funeral -d "Black Metal (Dark Funeral)"
  ...
  set -g fish_color_autosuggestion 222222
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 222222
  ...
  set -g fish_color_param 999999
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=222222
  set -g fish_color_selection white --bold --background=222222
  ...
  set -g base16_theme black-metal-dark-funeral
