...
function base16-humanoid-light -d "Humanoid light"
  ...
  set -g fish_color_autosuggestion deded8
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment deded8
  ...
  set -g fish_color_param 60615d
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=deded8
  set -g fish_color_selection white --bold --background=deded8
  ...
  set -g base16_theme humanoid-light
