...
function base16-irblack -d "IR Black"
  ...
  set -g fish_color_autosuggestion 484844
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 484844
  ...
  set -g fish_color_param 918f88
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=484844
  set -g fish_color_selection white --bold --background=484844
