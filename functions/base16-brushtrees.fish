...
function base16-brushtrees -d "Brush Trees"
  ...
  set -g fish_color_autosuggestion B0C5C8
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment B0C5C8
  ...
  set -g fish_color_param 8299A1
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=B0C5C8
  set -g fish_color_selection white --bold --background=B0C5C8
