...
function base16-brushtrees-dark -d "Brush Trees Dark"
  ...
  set -g fish_color_autosuggestion 6D828E
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 6D828E
  ...
  set -g fish_color_param 98AFB5
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=6D828E
  set -g fish_color_selection white --bold --background=6D828E
  ...
  set -g base16_theme brushtrees-dark
