...
function base16-mellow-purple -d "Mellow Purple"
  ...
  set -g fish_color_autosuggestion 331354
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 331354
  ...
  set -g fish_color_param 873582
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=331354
  set -g fish_color_selection white --bold --background=331354
  ...
  set -g base16_theme mellow-purple
