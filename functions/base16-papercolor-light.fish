...
function base16-papercolor-light -d "PaperColor Light"
  ...
  set -g fish_color_autosuggestion 008700
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 008700
  ...
  set -g fish_color_param 0087af
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=008700
  set -g fish_color_selection white --bold --background=008700
  ...
  set -g base16_theme papercolor-light
