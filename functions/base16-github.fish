...
function base16-github -d "Github"
  ...
  set -g fish_color_autosuggestion c8c8fa
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment c8c8fa
  ...
  set -g fish_color_param e8e8e8
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=c8c8fa
  set -g fish_color_selection white --bold --background=c8c8fa
