...
function base16-railscasts -d "Railscasts"
  ...
  set -g fish_color_autosuggestion 3a4055
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 3a4055
  ...
  set -g fish_color_param d4cfc9
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=3a4055
  set -g fish_color_selection white --bold --background=3a4055
