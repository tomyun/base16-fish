...
function base16-edge-dark -d "Edge Dark"
  ...
  set -g fish_color_autosuggestion b7bec9
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment b7bec9
  ...
  set -g fish_color_param 73b3e7
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=b7bec9
  set -g fish_color_selection white --bold --background=b7bec9
