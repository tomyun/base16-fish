...
function base16-material-darker -d "Material Darker"
  ...
  set -g fish_color_autosuggestion 353535
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 353535
  ...
  set -g fish_color_param B2CCD6
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=353535
  set -g fish_color_selection white --bold --background=353535
  ...
  set -g base16_theme material-darker
