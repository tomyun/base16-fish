...
function base16-atelier-savanna -d "Atelier Savanna"
  ...
  set -g fish_color_autosuggestion 526057
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 526057
  ...
  set -g fish_color_param 78877d
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=526057
  set -g fish_color_selection white --bold --background=526057
  ...
  set -g base16_theme atelier-savanna
