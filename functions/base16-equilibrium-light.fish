...
function base16-equilibrium-light -d "Equilibrium Light"
  ...
  set -g fish_color_autosuggestion d8d4cb
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment d8d4cb
  ...
  set -g fish_color_param 5a5f66
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=d8d4cb
  set -g fish_color_selection white --bold --background=d8d4cb
  ...
  set -g base16_theme equilibrium-light
