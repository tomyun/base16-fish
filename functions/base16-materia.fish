...
function base16-materia -d "Materia"
  ...
  set -g fish_color_autosuggestion 37474F
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 37474F
  ...
  set -g fish_color_param C9CCD3
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=37474F
  set -g fish_color_selection white --bold --background=37474F
