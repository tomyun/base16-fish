...
function base16-harmonic-light -d "Harmonic16 Light"
  ...
  set -g fish_color_autosuggestion cbd6e2
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment cbd6e2
  ...
  set -g fish_color_param 627e99
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=cbd6e2
  set -g fish_color_selection white --bold --background=cbd6e2
  ...
  set -g base16_theme harmonic-light
