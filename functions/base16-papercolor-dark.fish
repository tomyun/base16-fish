...
function base16-papercolor-dark -d "PaperColor Dark"
  ...
  set -g fish_color_autosuggestion 5faf00
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 5faf00
  ...
  set -g fish_color_param 5fafd7
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=5faf00
  set -g fish_color_selection white --bold --background=5faf00
  ...
  set -g base16_theme papercolor-dark
