...
function base16-windows-10-light -d "Windows 10 Light"
  ...
  set -g fish_color_autosuggestion d9d9d9
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment d9d9d9
  ...
  set -g fish_color_param ababab
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=d9d9d9
  set -g fish_color_selection white --bold --background=d9d9d9
  ...
  set -g base16_theme windows-10-light
