...
function base16-apathy -d "Apathy"
  ...
  set -g fish_color_autosuggestion 184E45
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 184E45
  ...
  set -g fish_color_param 5F9C92
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=184E45
  set -g fish_color_selection white --bold --background=184E45
