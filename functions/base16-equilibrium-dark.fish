...
function base16-equilibrium-dark -d "Equilibrium Dark"
  ...
  set -g fish_color_autosuggestion 22262d
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 22262d
  ...
  set -g fish_color_param 949088
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=22262d
  set -g fish_color_selection white --bold --background=22262d
  ...
  set -g base16_theme equilibrium-dark
