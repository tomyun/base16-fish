...
function base16-pico -d "Pico"
  ...
  set -g fish_color_autosuggestion 7e2553
  set -g fish_color_cancel -r
  set -g fish_color_command green #white
  set -g fish_color_comment 7e2553
  ...
  set -g fish_color_param ab5236
  set -g fish_color_quote yellow #brblack
  set -g fish_color_redirection cyan
  set -g fish_color_search_match bryellow --background=7e2553
  set -g fish_color_selection white --bold --background=7e2553
